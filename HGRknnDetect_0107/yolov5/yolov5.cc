...
int inference_yolov5_model(rknn_app_context_t *app_ctx, image_buffer_t *img, object_detect_result_list *od_results, image_buffer_t *dst_img)
{
    int ret;
    ...
    const float* box_conf_threshold_list = BOX_THRESH_LIST;
    int bg_color = 114;
    ...
    // Post Process
    post_process(app_ctx, outputs, &letter_box, box_conf_threshold, box_conf_threshold_list, nms_threshold, od_results);
